...
<div class="admin-shell" data-sidebar="expanded">
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav" aria-label="Menu administrativo">
            ...
            <a class="nav-link" href="#usuarios" data-section-link="usuarios"><i class="bi bi-people"></i><span>Usuários</span></a>
            ...
            <div class="topbar-actions">
                ...
                <div class="admin-profile dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#configuracoes" data-section-link="configuracoes">Meu perfil</a>
        ...
        <div class="admin-content">
            ...
            <section class="content-section active" id="dashboard" data-section>
                <div class="page-heading">
                    <div>
                        ...
                        <p>Dados reais do banco de dados e do cache de buscas do comparador.</p>
                    </div>
            ...
            <section class="content-section" id="historico" data-section>
                ...
                <article class="panel">
                    ...
                    <div class="table-responsive">
                        <table class="table admin-table align-middle">
                            <thead><tr><th>Termo</th><th>Usuário</th><th>Origem</th><th>Resultados</th><th>Data</th></tr></thead>
                            <tbody id="historicoBody"><tr><td colspan="5" class="text-muted">Carregando...</td></tr></tbody>
                        </table>
                    </div>
            ...
            <section class="content-section" id="produtos" data-section>
                <div class="page-heading compact">
                    <div><span class="eyebrow">Catálogo</span><h1>Produtos em Cache</h1><p>Produtos já coletados pelos scrapers e guardados no cache de buscas.</p></div>
            ...
            <section class="content-section" id="scrapers" data-section>
                <div class="page-heading compact">
                    <div><span class="eyebrow">Operação</span><h1>Monitoramento de Scrapers</h1><p>Estatísticas reais calculadas a partir do cache de buscas de cada loja.</p></div>
            ...
            <section class="content-section" id="configuracoes" data-section>
                <div class="page-heading compact">
                    <div><span class="eyebrow">Administração</span><h1>Configurações</h1><p>Parâmetros reais do sistema e da sua conta.</p></div>
                </div>
